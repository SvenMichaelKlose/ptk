// $Id: windowdrawer.cc,v 1.2 2001/10/11 03:31:17 sven Exp $
// $Source: /home/cvsroot/ptk/src/ptk/windowdrawer.cc,v $
//--------------------------------------------------------------------------
// Window drawer to embed ptk into X11 window managers
//
...
void window_drawer::putchar (dim* d,
			     int xp,int yp,
			     char chr,
			     color* colF, color* colB, font*
			    )
{
}
...
{
  Display* disp = x11_display ();
  XSetFont (disp, _gc, x11_font (fnt->drv ())->fontInfo ()->fid);
